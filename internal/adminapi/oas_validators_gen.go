...
func (s ClusterNodeState) Validate() error {
	switch s {
	case "ok":
		return nil
	case "unreachable":
...
func (s *ClusterNodeStatus) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *ClusterNodes) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *ClusterSignalStorage) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *ClusterStorage) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *ClusterTenantStorage) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s InstanceMode) Validate() error {
	switch s {
	case "node":
		return nil
	case "cluster":
...
func (s *MaintenanceStats) Validate() error {
	...
	var failures []validate.FieldError
	if err := func() error {
		if err := (validate.Float{}).Validate(float64(s.LastCycleDurationSeconds)); err != nil {
			return errors.Wrap(err, "float")
		}
		return nil
	}(); err != nil {
...
func (s RecordSignal) Validate() error {
	switch s {
	case "traces":
		return nil
	case "logs":
...
func (s *SignalEfficiency) Validate() error {
	...
	if err := func() error {
		if err := (validate.Float{}).Validate(float64(s.BytesPerPoint)); err != nil {
			return errors.Wrap(err, "float")
		}
		return nil
	}(); err != nil {
...
func (s *StreamCost) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *StreamCosts) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
