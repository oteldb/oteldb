...
// Register registers the odblogparser operator in a stanza operator registry.
func Register(registry *operator.Registry) {
	registry.Register(Type, NewBuilder)
}

// RegisterDefault registers the odblogparser operator in the default stanza registry.
